...
function onDateChange() {
    ...
    currentDate = newDate.getFullYear().toString().padStart(4, '0') + (newDate.getMonth() + 1).toString().padStart(2, '0') + newDate.getDate().toString().padStart(2, '0');
    // console.log(dateValue, dateStr);
    renderGeoraster(`https://dljsq618eotzp.cloudfront.net/oco2geos-co2-daygrid-v10r/oco2_GEOS_XCO2_L3CO2_day_B10206Ar_${currentDate}.tif`, currentDate);
}
