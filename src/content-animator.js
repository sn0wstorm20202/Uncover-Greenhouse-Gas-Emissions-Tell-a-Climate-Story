function toggleMenu(name, value) {
    document.getElementById(`${name}-menu-item-id`).className = value
        ? "cursor-pointer rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white"
        : "cursor-pointer rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white";
    document.getElementById(`${name}-mobile-menu-item-id`).className = value
        ? "cursor-pointer block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white"
        : "cursor-pointer block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white";
}
